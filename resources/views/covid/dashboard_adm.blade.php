  ...
  <div class="d-flex" id="wrapper">
    ...
    <div class="bg-light border-right" id="sidebar-wrapper">
      ...
      <ul>
        ...
        <li style="color:white;font-size: 12px;margin-top: 10px"><a href="{{route('atualizar')}}" style="color: white">Atualizar informações de referência para o CORONAVÍRUS-COVID19</a></li>
    ...
    <div id="page-content-wrapper">
      ...
      <div class="row">
        ...
        <div class="col-sm-12 col-lg-6">
          <p style="font-size: 15px;font-family: Heebo;text-align:center;margin-top: 20px;margin-bottom: 20px">Acompanhe em tempo real a evolução do vírus (Fonte: Johns Hopkins)</p>
          <iframe frameborder="0" scrolling="yes" marginheight="0" marginwidth="0" title="2019-nCoV" id="visao" style="height:80vh;width: 100%;margin-left:auto;margin-right: auto;display: block"src="//arcgis.com/apps/Embed/index.html?webmap=14aa9e5660cf42b5b4b546dec6ceec7c&extent=77.3846,11.535,163.5174,52.8632&zoom=true&previewImage=false&scale=true&disable_scroll=true&theme=dark"></iframe>
        </div>
      </div>
