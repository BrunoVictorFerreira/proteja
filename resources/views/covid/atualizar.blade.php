...
<body id="conteudoGeral">
  ...
  <div style="width: 100%;display:flex; flex-direction: column; align-items: center; justify-content: center">
    ...
    <span style="text-align:center;font-size: 15px;color: #148b7e;font-family: Heebo;margin-bottom: 10px">A seguir vamos atualizar algumas informações suas. Fique tranquilo, é super rápido.</span>
